...
import "@mailto:openzeppelin/contracts@4.8.2/token/erc1155/erc1155.sol";
import "@mailto:openzeppelin/contracts@4.8.2/access/ownable.sol";

contract MyToken is ERC1155, Ownable {
    uint[] supplies=[30,80,100];
    uint[] minted=[0,0,0];
